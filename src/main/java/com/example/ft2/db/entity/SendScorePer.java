...
public class SendScorePer implements Serializable {
    /**
    * id
     */
    private Long id;
    ...
    * 红包类型 0:赠送红包 1:邀请奖励 2:充值奖励
    ...
    public SendScorePer(Long id, Long sendUserId, Integer score, Long sendDateTime, String socreKey, Long receiveUserId, Long receiveDateTime, Integer status, Integer type) {
        this.id = id;
