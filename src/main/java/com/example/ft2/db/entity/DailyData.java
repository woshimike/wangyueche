...
public class DailyData implements Serializable {
    ...
    * 创建时间
    ...
    public DailyData(Long id, Long userNum, Long incrUserNum, Long totalTime, Long usedNum, Long rechargeAmount, Long loginNum, Long rihuoNum, Long systemTotalTime, Long createTime) {
        this.id = id;
