...
public class PersonSon implements Serializable {
    private Long id;
    ...
    * 来源渠道 0:无渠道 1:app内奖励渠道
    ...
    public PersonSon(Long id, String openid, String nickName, String avatarUrl, Integer gender, String country, String province, String city, String language, Long leftTime, Long inviteCode, Long inviter, Long createTime, Integer isMember, Long memberEndTime, Integer channel) {
        this.id = id;
        this.openid = openid;
